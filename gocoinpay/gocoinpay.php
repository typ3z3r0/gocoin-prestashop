...
{  
	...
	{
		$keys_to_uninstall = array('GOCOIN_MERCHANT_ID','GOCOIN_ACCESS_KEY', 'GOCOIN_TOKEN','GOCOIN_PAY_TYPE');
		...
		/* $result &= Db::getInstance()->Execute('DROP TABLE `'._DB_PREFIX_.'gocoin_transaction`'); */
	...
	public function getContent()
	{
		...
		$this->context->smarty->assign(array(
			...
			'gocoin_configuration' => Configuration::getMultiple(array( 'GOCOIN_MERCHANT_ID', 'GOCOIN_ACCESS_KEY',
				'GOCOIN_TOKEN', 'GOCOIN_PAY_TYPE')),
  ...
  public function checkCurrency($cart)
	...
	{
		return Db::getInstance()->Execute("
		INSERT INTO "._DB_PREFIX_."gocoin_ipn (cart_id, order_id, invoice_id, url, status, btc_price,
		price, currency, currency_type, invoice_time, expiration_time, updated_time)
		VALUES ('".$details['cart_id']."',
        '".$details['order_id']."',
        '".$details['invoice_id']."',
        '".$details['url']."',
        '".$details['status']."',
